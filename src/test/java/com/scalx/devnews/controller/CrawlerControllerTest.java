...
public class CrawlerControllerTest {
    ...
    public void test_crawl_whenGetArticleLinksAsListIsNotPresent() throws Exception {
        ...
        verifyNoMoreInteractions(crawlerController);
    }
    ...
    public void test_crawl_whenCrawlArticleLinkIntoArticleIsNotPresent() throws Exception {
        ...
        when(crawlerService.crawlArticleLinkIntoArticle("www.dzone.com/Comprehensive-guide-to-unit-testing"))
        ...
        assertThatExceptionOfType(IOException.class)
                .isThrownBy(() -> {
                    crawlerService.crawlArticleLinkIntoArticle("www.dzone.com/Comprehensive-guide-to-unit-testing");
                });

        verify(urlService).getArticleLinksAsList();
        verify(crawlerService).crawlArticleLinkIntoArticle("www.dzone.com/Comprehensive-guide-to-unit-testing");
        verifyNoMoreInteractions(crawlerController);
    }
    ...
    public void test_crawl_whenEverythingIsPresent() throws Exception {
        ...
        when(crawlerService.crawlArticleLinkIntoArticle("www.dzone.com/Comprehensive-guide-to-unit-testing").get())
                .thenReturn(article);
